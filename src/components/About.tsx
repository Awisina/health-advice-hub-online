        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              Наш сайт предоставляет удобную платформу для получения высококачественных медицинских консультаций, 
              объединяя современные цифровые технологии с профессиональным медицинским сервисом.
            </p>
            <p className="text-lg text-gray-600 mb-8">
              Мы создали цифровое пространство, где пациенты могут легко найти квалифицированных врачей, 
              записаться на консультации и получить медицинскую помощь в удобном формате.
            </p>
